...
#define OPT_NMISC_NWWDGHALT         (0<<0)
#define OPT_NMISC_NWWDGHW           (0<<1)
#define OPT_NMISC_NIWDGHW           (0<<2)
#define OPT_NMISC_NLSIEN            (0<<3)
#define OPT_NMISC_NHSITRIM          (0<<4)
//#define OPT_NMISC_Res             (0<<5)
//#define OPT_NMISC_Res             (0<<6)
//#define OPT_NMISC_Res             (0<<7)
